...
/**
 * A {@link com.path.android.jobqueue.nonpersistentqueue.MergedQueue} class that can separate jobs based on their network requirement
 */
public class NetworkAwarePriorityQueue extends MergedQueue {
  ...
  /**
   * create a {@link com.path.android.jobqueue.nonpersistentqueue.TimeAwarePriorityQueue}
   *
