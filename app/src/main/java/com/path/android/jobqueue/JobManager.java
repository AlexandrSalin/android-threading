...
public class JobManager implements NetworkEventProvider.Listener {
  ...
  /**
   * Default constructor that will create a JobManager with a default {@link com.path.android.jobqueue.config.Configuration}
   *
   ...
   * @see #addJob(com.path.android.jobqueue.Job)
   */
  ...
  /**
   * Returns the current status of a {@link com.path.android.jobqueue.Job}.
   * <p>
  ...
  /**
   * if {@link com.path.android.jobqueue.network.NetworkUtil} implements {@link com.path.android.jobqueue.network.NetworkEventProvider}, this method is called when network is recovered
   *
  ...
  /**
   * Deprecated, please use {@link #addJob(com.path.android.jobqueue.Job)}.
   * <p/>
  ...
  /**
   * Please use {@link #addJobInBackground(com.path.android.jobqueue.Job)}.
   * <p>Non-blocking convenience method to add a job in background thread.</p>
   *
   * @see #addJob(int, com.path.android.jobqueue.BaseJob) addJob(priority, job).
   */
  @Deprecated
  ...
  /**
   * Deprecated, please use {@link #addJobInBackground(com.path.android.jobqueue.Job)}.
   * <p></p>Non-blocking convenience method to add a job in background thread.</p>
   *
   * @see #addJob(int, long, com.path.android.jobqueue.BaseJob) addJob(priority, delay, job).
   */
  @Deprecated
   ...
   * both are wrapped inside a {@link com.path.android.jobqueue.cachedQueue.CachedJobQueue} to improve performance
   */
