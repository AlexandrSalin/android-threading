...
/**
 * A queue implementation that utilize two queues depending on one or multiple properties of the {@link com.path.android.jobqueue.JobHolder}
...
abstract public class MergedQueue implements JobSet {
  ...
  /**
   * @param initialCapacity    passed to {@link com.path.android.jobqueue.nonpersistentqueue.MergedQueue#createQueue(com.path.android.jobqueue.nonpersistentqueue.MergedQueue.SetId, int, java.util.Comparator)}
   * @param comparator         passed to {@link com.path.android.jobqueue.nonpersistentqueue.MergedQueue#createQueue(com.path.android.jobqueue.nonpersistentqueue.MergedQueue.SetId, int, java.util.Comparator)}
