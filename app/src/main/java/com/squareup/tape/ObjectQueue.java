...
public interface ObjectQueue<T> {
  ...
  /**
   * Enqueue an entry that can be processed at any time.
   */
  void add(T entry);
  ...
  /**
   * Sets a listener on this queue. Invokes {@link com.squareup.tape.ObjectQueue.Listener#onAdd} once for each entry that's
