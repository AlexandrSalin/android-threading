...
/**
 * Decorates {@link com.octo.android.robospice.request.SpiceRequest} and provides additional information used by
 * RoboSpice.
 *
 * @param <RESULT>
 * @author SNI
...
public class CachedSpiceRequest<RESULT> extends SpiceRequest<RESULT> {
   ...
   *
   * @param future the future result of this request.
   */
  @Override
