...
import com.octo.android.robospice.command.*;
...
/**
 * The instances of this class allow to access the {@link SpiceService}. <br/>
 * They are tied to activities and obtain a local binding to the
 * {@link SpiceService}. When binding occurs, the {@link com.octo.android.robospice.SpiceManager} will send
 ...
 * {@link SpiceService} are accessible from the {@link com.octo.android.robospice.SpiceManager}. It acts as
 * an asynchronous proxy : every call to a {@link SpiceService} method is
 * asynchronous and will occur as soon as possible when the {@link com.octo.android.robospice.SpiceManager}
...
public class SpiceManager implements Runnable {
  ...
  /**
   * Whether or not {@link com.octo.android.robospice.SpiceManager} is started. Must be volatile to
  ...
  /**
   * Start the {@link com.octo.android.robospice.SpiceManager}. It will bind asynchronously to the
   * {@link SpiceService}.
   *
   * @param context a context that will be used to bind to the service. Typically,
  ...
  /**
   * Method is synchronized with {@link #start(android.content.Context)}.
   *
   * @return whether or not the {@link com.octo.android.robospice.SpiceManager} is started.
   */
  ...
  /**
   * Stops the {@link com.octo.android.robospice.SpiceManager}. It will unbind from {@link SpiceService}.
   * All request listeners that had been registered to listen to
   * {@link SpiceRequest}s sent from this {@link com.octo.android.robospice.SpiceManager} will be
  ...
  /**
   * This is mostly a testing method. Stops the {@link com.octo.android.robospice.SpiceManager}. It will
   ...
   * {@link com.octo.android.robospice.SpiceManager} will be unregistered. None of them will be notified
   ...
   *
   * @param clazz               the class of the result to retrieve from cache.
   * @param requestCacheKey     the key used to store and retrieve the result of the request
   *                            in the cache
   * @param cacheExpiryDuration duration in milliseconds after which the content of the cache
   ...
   * @param requestListener     the listener to notify when the request will finish. If
   ...
   * listener.
   *
   * @param clazz           the class of the result of the pending request to look for.
   * @param requestCacheKey the key used to store and retrieve the result of the request
   *                        in the cache
   * @param requestListener the listener to notify when the request will finish.
   */
   ...
   *
   * @param cachedSpiceRequest the request to execute. {@link CachedSpiceRequest} is a
   ...
   *
   * @param clazz           a super class or the class of data.
   * @param requestCacheKey the request cache key that data will be stored in.
   * @param data            the data to store. Maybe null if supported by underlying
   *                        ObjectPersister.
   * @param listener        a listener that will be notified of this request's success or
   *                        failure. May be null.
   */
   ...
   *
   * @param clazz           the class of the result of the pending request to look for.
   * @param requestCacheKey the cache key associated to the request's results.
   */
   ...
   *
   * @param request Request for which listeners are to unregistered.
   */
   ...
   * {@link SpiceService}.
   *
   * @param request the request for which listeners must be unregistered.
   ...
   * Should be called in {@link android.app.Activity#onStop}
   */
   ...
   *
   * @throws InterruptedException in case service binding fails.
   */
   ...
   * {@link SpiceRequest}.
   *
   * @param cachedSpiceRequest the request know by the {@link com.octo.android.robospice.SpiceManager}.
   * @param spiceRequest       the request that we wish to remove notification for.
   ...
   *
   * @param clazz    the class of the result to retrieve from cache.
   * @param cacheKey the key used to store and retrieve the result of the request
   *                 in the cache
   ...
   * from cache.
   * @throws CacheLoadingException Exception thrown when a problem occurs while loading data
   *                               from cache.
   */
   ...
   *                            never returned.(see {@link DurationInMillis})
   * @return the data has it has been saved by an ObjectPersister in cache.
   * @throws CacheCreationException Exception thrown when a problem occurs while looking for data
   *                                in cache.
   */
   ...
   *
   * @param clazz    the Type of data you want to remove from cache
   * @param cacheKey the key of the object in cache
   */
   ...
   *
   * @param failOnCacheError true if an error must fail the process
   */
   ...
   *
   * @throws InterruptedException in case the binding is interrupted.
   */
    ...
    public T call() {
      synchronized (spiceManager) {
        ...
        try {
          ...
          Ln.e(e, "Spice command %s couldn't bind to service.", clazz.getName());
        }
