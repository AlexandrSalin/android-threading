 ...
 * <p/>
 * The operation proposed by a {@link com.octo.android.robospice.persistence.keysanitation.KeySanitizer} must be bijective.
 *
 * @author SNI
 */
public interface KeySanitizer {
   ...
   *
   * @param sanitizedCacheKey the cache key to de-sanitize.
