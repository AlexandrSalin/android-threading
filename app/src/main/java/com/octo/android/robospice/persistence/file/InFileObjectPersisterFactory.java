...
public abstract class InFileObjectPersisterFactory extends ObjectPersisterFactory implements CacheCleaner {
   ...
   *
   * @param cacheFolder the new cache folder of this factory (and persisters it will
   *                    create). Ca be null, it will then default to the sub folder
   *                    {@link com.octo.android.robospice.persistence.file.InFileObjectPersister#DEFAULT_ROOT_CACHE_DIR} in side
   ...
   *
   * @param cachePrefix the new cache cachePrefix of this factory (and persisters it
   ...
   *                     {@link com.octo.android.robospice.persistence.file.InFileObjectPersisterFactory} and persisters. May be
