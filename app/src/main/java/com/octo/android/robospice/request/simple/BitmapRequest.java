...
public class BitmapRequest extends SpiceRequest<Bitmap> implements IBitmapRequest {
  ...
  /**
   * Creates a BitmapRequest able to fetch a {@link android.graphics.Bitmap} from the network.
   *
   * @param url       the url of the bitmap to fetch.
   * @param cacheFile a file used to store data during download.
   */
   ...
   *
   * @param url       the url of the bitmap to fetch.
   * @param options   used to decode the data received from the network.
   * @param cacheFile a file used to store data during download.
   */
