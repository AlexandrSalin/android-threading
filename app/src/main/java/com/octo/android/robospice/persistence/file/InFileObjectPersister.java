 ...
 *
 * @param <T> the class of the data to load/save.
 * @author sni
 */
public abstract class InFileObjectPersister<T> extends ObjectPersister<T> {
   ...
   *
   * @param cacheFolder the new cache folder to use. Can be null, will then default to
   *                    {@link #DEFAULT_ROOT_CACHE_DIR} sub folder in the application
   *                    cache dir.
   * @throws CacheCreationException if the cache folder doesn't exist or can't be created.
   */
  ...
  /**
   * @return Whether or not this {@link com.octo.android.robospice.persistence.file.InFileObjectPersister} uses a
   * {@link KeySanitizer}.
   */
  ...
  /**
   * @return the key sanitizer used by this {@link com.octo.android.robospice.persistence.file.InFileObjectPersister}. May
  ...
  /**
   * @param keySanitizer the new key sanitizer to be used by this
   *                     {@link com.octo.android.robospice.persistence.file.InFileObjectPersister}. May be null, in that case no
   ...
   *
   * @param cacheKey a non-sanitized cacheKey.
   ...
   * used.
   *
   * @param cacheKey a possibly sanitized cacheKey.
