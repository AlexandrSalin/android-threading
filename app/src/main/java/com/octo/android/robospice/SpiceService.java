 ...
 * {@link #createCacheManager(android.app.Application)} to configure the
...
public abstract class SpiceService extends Service {
   ...
   *
   * @param cacheManager           the cache manager used by this service.
   * @param requestProgressManager will notify of requests progress.
   * @param requestRunner          executes requests.
   ...
   * implementation : @see {@link com.octo.android.robospice.SpiceService.SelfStopperRequestProcessorListener}.
   *
  ...
  /**
   * Factory method to create an {@link java.util.concurrent.ExecutorService} that will be used to
   * execute requests. The default implementation of this method will create a
   * single threaded or multi-threaded {@link java.util.concurrent.ExecutorService} depending on
   ...
   * Ciovati.
   *
   * @return the {@link java.util.concurrent.ExecutorService} to be used to execute requests .
   */
