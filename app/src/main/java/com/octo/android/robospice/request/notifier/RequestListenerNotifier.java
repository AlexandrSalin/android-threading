...
public interface RequestListenerNotifier {
   ...
   * {@link com.octo.android.robospice.SpiceManager#addListenerIfPending(Class, Object, com.octo.android.robospice.request.listener.PendingRequestListener)}
   * .
   *
   * @param request   a given request.
   * @param listeners a set of {@link com.octo.android.robospice.request.listener.RequestListener}. Only instances of
   *                  {@link com.octo.android.robospice.request.listener.PendingRequestListener} will be notified of the event.
   */
   ...
   *
   * @param request   a given request.
   * @param listeners a set of {@link com.octo.android.robospice.request.listener.RequestListener}.
   */
   ...
   *
   * @param request   a given request.
   * @param listeners a set of {@link com.octo.android.robospice.request.listener.RequestListener}. Only
   *                  {@link com.octo.android.robospice.request.listener.RequestProgressListener} will be notified of the event.
   */
   ...
   *
   * @param request   the request not to notify listeners of.
   * @param listeners the listeners that won't be notified.
   */
