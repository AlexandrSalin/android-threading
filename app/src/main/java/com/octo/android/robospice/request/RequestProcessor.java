...
/**
 * Delegate class of the {@link com.octo.android.robospice.SpiceService}, easier to test than an Android
...
public class RequestProcessor {
   ...
   * will finish.<br/>
   *
   * @param request             Request on which you want to disable listeners
   * @param listRequestListener the collection of listeners associated to request not to be
   *                            notified
   */
